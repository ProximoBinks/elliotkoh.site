    ...
    <div className="max-w-4xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
      ...
      <form name="contact" onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="flex justify-center">
          <button
            type="submit"
            className="w-full sm:w-auto transition-all py-3 px-6 bg-[#8fb4dc] hover:bg-[#7999ba] focus:ring-blue-500 focus:ring-offset-2 text-white font-semibold rounded-3xl hover:px-8 shadow-lg shadow-[#8fb4dc]/50 hover:shadow-[#7999ba]/50 focus:outline-none focus:ring-2"
          >
            Send Message
          </button>
        </div>
